...
export class CalendarEventSidebarComponent implements OnInit, AfterViewInit {
  ...
  public duration = [
    ...
    { label: "02:30", value: "2:30" },
    { label: "03:00", value: "3:00" },
    { label: "03:30", value: "3:30" },
    { label: "04:00", value: "4:00" },
    { label: "04:30", value: "4:30" },
    { label: "05:00", value: "5:00" },
    { label: "05:30", value: "5:30" },
    { label: "06:00", value: "6:00" },
    { label: "06:30", value: "6:30" },
    { label: "07:00", value: "7:00" },
    { label: "07:30", value: "7:30" },
    ...
    const subscription = this._calendarService.onCurrentEventChange$
      ...
      .subscribe((eventRef) => {
        ...
        this.formCalendar.patchValue({
          ...
          roomNumber: extendedProps.roomNumber,
  ...
  patientchange() {
    ...
    if (valueIdPatient != null) {
      ...
      this.patient$.subscribe((responseData) => {
        ...
        this.formCalendar
          .get("agepacient")
          .setValue(responseData.data[0].age);
  ...
  selectCirugia() {
    ...
    this.cirugiaSelect$ =
      this._cirugiaListService.getCirugiasById(valueIdspecialty);
  }
}
