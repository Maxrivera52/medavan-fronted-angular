...
@Component({
  selector: "app-anesthesia-list",
  templateUrl: "./anesthesia-list.component.html",
  styleUrls: ["./anesthesia-list.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class AnesthesiaListComponent implements OnInit {
  // Public
   ...
   * @param {AnesthesiaListService} _anesthesiaListService
  ...
  ngOnInit(): void {
    ...
    this._anesthesiaListService.changeList$
    .pipe(
      switchMap(() => this._anesthesiaListService.getAnesthesias()),
  ...
  selectAnesthesia(anesthesia: IAnesthesia): void {
    this._anesthesiaListService.anesthesiaSelected$.next(anesthesia);
    this._coreSidebarService
      .getSidebarRegistry("new-anesthesia-sidebar")
      .toggleOpen();
  }

  deletAnesthesia(id: number) {
    this._anesthesiaListService
      .deleteAnesthesia(id)
