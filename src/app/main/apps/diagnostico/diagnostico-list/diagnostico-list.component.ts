...
export class DiagnosticoListComponent implements OnInit {
   ...
   * @param {DiagnosticoListService} _diagnosticoListService
  ...
  ngOnInit(): void {
    ...
    this._diagnosticoListService.changeList$
    .pipe(
      switchMap(() => this._diagnosticoListService.getDiagnosticos()),
  ...
  selectDiagnostico(diagnostico: IDiagnostico): void {
    this._diagnosticoListService.diagnosticoSelected$.next(diagnostico);
    this._coreSidebarService
      .getSidebarRegistry("new-diagnostico-sidebar")
      .toggleOpen();
  }

  deletDiagnostico(id: number) {
    this._diagnosticoListService
