...
import { ProveedorListService } from "app/main/apps/proveedor/proveedor-list/proveedor-list.service";
...
export class ProveedorListComponent implements OnInit {
   ...
   * @param {ProveedorListService} _proveedorListService
  ...
  ngOnInit(): void {
    // Subscribe config change
      ...
      this._proveedorListService.changeList$
      .pipe(
        switchMap(() => this._proveedorListService.getProveedors()),
  ...
  selectProveedor(proveedor: IProveedor): void {
    this._proveedorListService.proveedorSelected$.next(proveedor);
    this._coreSidebarService
      .getSidebarRegistry("new-proveedor-sidebar")
      .toggleOpen();
  }

  deletProveedor(id: number) {
    this._proveedorListService
      .deleteProveedor(id)
