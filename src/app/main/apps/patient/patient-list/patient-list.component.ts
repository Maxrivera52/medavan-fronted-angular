...
export class PatientListComponent implements OnInit {
  ...
  ngOnInit(): void {
    // Subscribe config change
      ...
      this._patientListService.changeList$
      .pipe(
        switchMap(() => this._patientListService.getPatients()),
  ...
  selectPatient(patient: IPatient): void {
    this._patientListService.patientSelected$.next(patient);
    this._coreSidebarService
      .getSidebarRegistry("new-patient-sidebar")
      .toggleOpen();
  }
