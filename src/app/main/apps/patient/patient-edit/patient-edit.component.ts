...
import { locale as english }    from 'app/main/apps/patient/patient-edit/i18n/en';
...
export class PatientEditComponent implements OnInit, OnDestroy {
   ...
   *
   * @param {Router} router
   * @param {PatientEditService} _patientEditService
   */
  constructor(private router: Router, private _patientEditService: PatientEditService, private _coreTranslationService: CoreTranslationService) {
