...
import { NewPatientSidebarComponent } from "app/main/apps/patient/patient-list/new-patient-sidebar/new-patient-sidebar.component";
...
const routes: Routes = [
  ...
  },
  {
    ...
    data: { animation: "PatientEditComponent" },
  },
  {
    path: "patient-view",
...
@NgModule({
  ...
  providers: [PatientViewService, PatientEditService],
})
