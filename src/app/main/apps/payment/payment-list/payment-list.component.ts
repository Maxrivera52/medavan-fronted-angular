...
export class PaymentListComponent implements OnInit {
   ...
   * @param {PaymentListService} _paymentListService
  ...
  ngOnInit(): void {
    ...
    this._paymentListService.changeList$
    .pipe(
      switchMap(() => this._paymentListService.getPayments()),
  ...
  selectPayment(payment: IPayment): void {
    this._paymentListService.paymentSelected$.next(payment);
    this._coreSidebarService
      .getSidebarRegistry("new-payment-sidebar")
      .toggleOpen();
  }

  deletPayment(id: number) {
    this._paymentListService
      .deletePayment(id)
